...
| `${ACME_CERT_ROOT:-/volume2/certs/acme}` | `/volume2/certs/acme` | rw   | operator      |
...
- `ls -la /volume2/certs/acme/<domain>/` -- PEMs newer than 90 days
