...
#   sudo sh /volume2/docker/nas-reset.sh --yes         # non-interactive
#   sudo sh /volume2/docker/nas-reset.sh --dry-run     # preflight only
#   sudo sh /volume2/docker/nas-reset.sh --yes --fix   # non-interactive + fix .env
#
# What it does:
...
echo ""
echo " Next steps:"
echo "   1. sudo cp ${CE_STACKS_DIR}/scripts/dockge-start.sh \\"
echo "         /usr/local/etc/rc.d/dockge.sh"
echo "   2. sudo cp ${CE_STACKS_DIR}/scripts/portainer-start.sh \\"
echo "         /usr/local/etc/rc.d/portainer.sh"
echo "   3. sudo chmod +x /usr/local/etc/rc.d/{dockge,portainer}.sh"
echo "   4. sudo sh /usr/local/etc/rc.d/dockge.sh"
echo "   5. sudo sh /usr/local/etc/rc.d/portainer.sh"
echo "   6. Open Dockge: http://10.0.1.15:5571"
echo "   7. Deploy stacks in order per README.md"
echo "============================================"
