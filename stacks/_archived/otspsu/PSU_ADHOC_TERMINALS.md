...
2. **Credentials / Run As**: create or reuse a **secret / credential** that maps to the Linux user inside the `otspsu` container (or a dedicated sidecar) that:
...
- Host SSH for jobs: `stacks/otspsu/NAS_HOST_SSH_SETUP.md`
