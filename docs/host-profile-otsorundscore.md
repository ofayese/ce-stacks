...
| **Usable for stacks** (`HOST_MEM_BUDGET_MB`) | **26 GB (26 624 MB)** | Hard ceiling for Σ `mem_limit` across simultaneously-running stacks |
| Hard CPU cap per heavy service | `cpus: "1.5"` | 75 % of one core × 2 cores ≈ never starve DSM |
